...
_AA = ["vn_o_men_nva_01", "vn_o_men_nva_43", "vn_o_men_nva_11", "vn_o_men_nva_09"];
...
zmm_fnc_spawnUnit = {
	...
	if ({ alive _x && _x distance2D _startingPos < (if _isAir then {1000} else {50})} count allPlayers > 0 && isMultiplayer) exitWith { 
		systemChat "to close for comfort";
		sleep 30;
...
for [{_wave = 1}, {_wave < _waveMax}, {_wave = _wave + 1}] do {
	...
	switch (_wave) do {
		default {
			[_location, _spawns, _side, [_Sentry,_Team,_Squad,_AA,ZMM_EASTMan] selectRandomWeighted [0.75,0.5,0.25,0.1,0.1]] call zmm_fnc_spawnUnit;
			[_location, _spawns, _side, [_Sentry,_Team,_Squad,_AA,ZMM_EASTMan] selectRandomWeighted [0.75,0.5,0.25,0.1,0.1]] call zmm_fnc_spawnUnit;
			[_location, _spawns, _side, [_Sentry,_Team,_Squad,_AA,ZMM_EASTMan] selectRandomWeighted [0.75,0.5,0.25,0.1,0.1]] call zmm_fnc_spawnUnit;
			[_location, _spawns, _side, [_Sentry,_Team,_Squad,_AA,ZMM_EASTMan] selectRandomWeighted [0.75,0.5,0.25,0.1,0.1]] call zmm_fnc_spawnUnit;
			[_location, _spawns, _side, [_Sentry,_Team,_Squad,_AA,ZMM_EASTMan] selectRandomWeighted [0.75,0.5,0.25,0.1,0.1]] call zmm_fnc_spawnUnit;
